<template>
  <section class="panel active" id="panel-timeline">
    <div class="stat-grid">
      <div class="stat"><div class="accent a-plum"></div><div class="num">{{ store.timeline.length }}</div><div class="lbl">Total Tugas</div></div>
      <div class="stat"><div class="accent a-teal"></div><div class="num">{{ done }}</div><div class="lbl">Selesai</div></div>
      <div class="stat"><div class="accent a-gold"></div><div class="num">{{ inProc }}</div><div class="lbl">Sedang Dikerjakan</div></div>
      <div class="stat"><div class="accent a-rose"></div><div class="num">{{ overdue }}</div><div class="lbl">Terlambat</div></div>
    </div>
